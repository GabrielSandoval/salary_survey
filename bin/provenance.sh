# Output extracted YW commands found in the high_level_workflow.py file
...
java -jar ./bin/yesworkflow-0.2.0-jar-with-dependencies.jar \
  ...
  ./high_level_workflow.py | dot -Tpng -o ./provenance/High_Level_Cleaning_Workflow_combined_view.png && \
...
java -jar ./bin/yesworkflow-0.2.0-jar-with-dependencies.jar \
  ...
  -config graph.workflowbox=show \
  -config graph.layout=TB \
  ./high_level_workflow.py | dot -Tpng -o ./provenance/High_Level_Cleaning_Workflow_data_view.png && \
...
java -jar ./bin/yesworkflow-0.2.0-jar-with-dependencies.jar \
  ...
  -config graph.workflowbox=show \
  -config graph.layout=TB \
  ./high_level_workflow.py | dot -Tpng -o ./provenance/High_Level_Cleaning_Workflow_process_view.png && \
